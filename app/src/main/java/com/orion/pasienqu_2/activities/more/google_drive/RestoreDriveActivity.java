...
public class RestoreDriveActivity extends CustomAppCompatActivity {
    ...
    public static RestoreDriveActivity mInstance;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mInstance = this;
        setContentView(R.layout.activity_restore_google_drive);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        setTitle(getString(R.string.restore_drive));
        CreateView();
        InitClass();
        EventClass();
    }
    ...
    private void InitClass() {
        ...
        isMasterDevice = prefs.getBoolean("master_device", true);
    ...
    private void EventClass() {
        btnDownload.setOnClickListener(view -> {
            ...
            ProgressDialog progressDialog = Global.createProgresSpinner(RestoreDriveActivity.this, getString(R.string.loading));
            progressDialog.show();
                    ...
                    .addOnSuccessListener(new OnSuccessListener() {
                        ...
                        public void onSuccess(Object o) {
                            ...
                            Runnable runDownload = new Runnable() {
                                @Override
                                public void run() {
                                    DriveUtil.download(RestoreDriveActivity.this);
                                }
                            };
                            ...
                            if (lastMedicalRecordDate >= lastModifiedTimeBackup) {
                                strInfoDate.append(RestoreDriveActivity.this.getString(R.string.warning_restore_version)).append("\n");
                                strInfoDate.append(RestoreDriveActivity.this.getString(R.string.google_drive_version)).append(Global.getDateFormated(lastModifiedTimeBackup, "dd/MM/yyyy HH:mm")).append("\n");
                                strInfoDate.append(RestoreDriveActivity.this.getString(R.string.device_version)).append(Global.getDateFormated(lastMedicalRecordDate, "dd/MM/yyyy HH:mm")).append("\n");

                                ShowDialog.overwriteDialog(RestoreDriveActivity.this, getString(R.string.restore_your_data), strInfoDate.toString(), getString(R.string.inform_confirm_restore), runDownload);
                            }else{
                                ShowDialog.confirmDialog(RestoreDriveActivity.this, getString(R.string.restore_your_data), getString(R.string.inform_confirm_restore), runDownload);
                            }
